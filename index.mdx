---
title: "Introdução"
description: "A Coca-Cola tem uma longa história de slogans, que refletem a evolução da marca e as suas estratégias de marketing."
icon: "handshake"
mode: "custom"
---
...
<p className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
  LabEscape™ é um jogo educacional, com profundidade visual, mecânica e design dignos de um jogo comercial, respeitando as limitações de hardware e orçamento.
</p>
